...
import { CharFieldValidator, NoWhiteSpaceValidator, NumericFieldValidator } from '../../../../shared/validations/validations.validator';
      ...
      if (res.isSuccess) {
        ...
        this._httpService.get(environment.BASE_API_PATH + "ProductMaster/GetProductPicturebyId/" + id).subscribe(res => {
          if (res.isSuccess && res.data.length > 0) {
            this.images = [
              { img: res.data[0].name != null ? environment.BASE_IMAGE_PATH + "Shop/" + res.data[0].name : "assets/images/noimage.png" },
              { img: res.data[1].name != null ? environment.BASE_IMAGE_PATH + "Shop/" + res.data[1].name : "assets/images/noimage.png" },
              { img: res.data[2].name != null ? environment.BASE_IMAGE_PATH + "Shop/" + res.data[2].name : "assets/images/noimage.png" },
              { img: res.data[3].name != null ? environment.BASE_IMAGE_PATH + "Shop/" + res.data[3].name : "assets/images/noimage.png" },
              { img: res.data[4].name != null ? environment.BASE_IMAGE_PATH + "Shop/" + res.data[4].name : "assets/images/noimage.png" }
            ];
          } else {
